...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in zero_gene:
        if (people[person]["mother"]):
            ...
            father_pass = pass_gene(father_genes)
            mother_pass = pass_gene(mother_genes)

            prob *= (1 - father_pass) * (1 - mother_pass)
    ...
    for person in one_gene:
        if (people[person]["mother"]):
            ...
            prob *= (1 - father_pass) * (mother_pass) + (father_pass) * (1 - mother_pass)
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        probabilities[person]["gene"][0] /= sum
        probabilities[person]["gene"][1] /= sum
        probabilities[person]["gene"][2] /= sum
